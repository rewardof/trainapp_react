...
const TableView = ({
    ...
    const columns = [
        ...
        {
            title: "Lokomotivning tortish rejimidagi harakatiga asosiy solishtirma qarshilik",
        ...
        {
            title: "Lokomotivning salt yurish rejimidagi harakatiga asosiy solishtirma qarshilik",
        ...
        {
            title: " Manyovr tarkibining tortish rejimidagi harakatiga asosiy solishtirma qarshilik",
        ...
        {
            title: "Manyovr tarkibining salt yurish rejimidagi harakatiga asosiy solishtirma qarshilik",
...

        {
            ...
            sorter: {
                compare: (a, b) => a.switch_curvature_resistance - b.switch_curvature_resistance,
                multiple: 2,
            },
            align: "center",
            width: 200
...

        {
            ...
            sorter: {
                compare: (a, b) => a.outside_temperature_resistance - b.outside_temperature_resistance,
                multiple: 2,
            },
            align: "center",
            width: 170
        ...
        {
            title: "Harakatga qarama-qarshi va yon tomondan shamolning solishtirma qarshiligi",
            dataIndex: "wind_capacity_resistance",
            sorter: {
                compare: (a, b) => a.wind_capacity_resistance - b.wind_capacity_resistance,
                multiple: 2,
            },
            align: "center",
            width: 230
...

        {
            ...
            sorter: {
                compare: (a, b) => a.railroad_condition_resistance - b.railroad_condition_resistance,
                multiple: 2,
            },
            align: "center",
            width: 170
        ...
        {
            title: "Manoyvr tarkibining tortish rejimidagi harakatiga umumiy qarshilik",
            dataIndex: "all_traction_resistance",
            sorter: {
                compare: (a, b) => a.all_traction_resistance - b.all_traction_resistance,
                multiple: 2,
            },
            align: "center",
            width: 230
        ...
        {
            title: "Manyovr tarkibining tortish rejimidagi harakatiga solishtirma qarshilik",
            dataIndex: "specific_traction_resistance",
            sorter: {
                compare: (a, b) => a.specific_traction_resistance - b.specific_traction_resistance,
                multiple: 2,
            },
            align: "center",
            width: 230
        ...
        {
            title: "Manyovr tarkibining salt rejimidagi harakatiga solishtirma qarshilik",
            dataIndex: "specific_idle_resistance",
            sorter: {
                compare: (a, b) => a.specific_idle_resistance - b.specific_idle_resistance,
                multiple: 2,
            },
            align: "center",
            width: 230
    ...
    return (
        <div>
            ...
            <Table columns={columns} dataSource={data} sticky size="middle"
